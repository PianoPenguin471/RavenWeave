...
import ravenweave.client.utils.RandomUtils;
    ...
    public void onPacket(PacketEvent e) {
        if (e.getPacket() instanceof S12PacketEntityVelocity) {
            ...
            if (entity == mc.thePlayer && mc.thePlayer.onGround && !Keyboard.isKeyDown(key)) {
                ...
                javax.swing.Timer timer = new javax.swing.Timer(RandomUtils.nextInt((int)delay.getInputMin(), (int)delay.getInputMax()), actionevent -> KeyBinding.setKeyBindState(mc.gameSettings.keyBindJump.getKeyCode(), false));
