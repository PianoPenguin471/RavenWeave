package ravenweave.client.utils.version;
...
public class VersionManager {
	private final String versionFilePath = "/assets/ravenweave/version";
	private final String branchFilePath = "/assets/ravenweave/branch";
