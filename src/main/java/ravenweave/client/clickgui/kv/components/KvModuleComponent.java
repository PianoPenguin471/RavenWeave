...
public class KvModuleComponent extends KvComponent{
    ...
    private final static ResourceLocation settingIcon = RenderUtils.getResourcePath("/assets/ravenweave/kvclickgui/gear.png");;
	...
	moduleIcon = RenderUtils.getResourcePath("/assets/ravenweave/raven.png"); //use this temporarily until there are enough icons for BetaGui
