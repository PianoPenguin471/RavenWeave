...
import static keystrokesmod.client.utils.ReflectionUtils.getPrivateValue;
import static keystrokesmod.client.utils.ReflectionUtils.setPrivateValue;
...
public class Utils {
    ...
    public static class Client {
        ...
        public static void setMouseButtonState(int mouseButton, boolean held) {
            ...
            setPrivateValue(Mouse.class, null, buttons, "buttons");
        ...
        public static net.minecraft.util.Timer getTimer() {
            return (net.minecraft.util.Timer) getPrivateValue(Minecraft.class, Minecraft.getMinecraft(), "timer");
        }
